...
const Tooltip = ({ content, children }) => (
  <div className="group relative flex items-center justify-center z-[50]">
    {children}
    {/* Removed 'pointer-events-none' so you can click links inside the tooltip */}
    <div className="absolute top-full mt-3 px-4 py-3 bg-[#020617] border border-slate-700 text-left rounded-xl opacity-0 group-hover:opacity-100 transition-all duration-200 w-72 shadow-2xl transform translate-y-2 group-hover:translate-y-0 z-[60]">
      {content}
